...
var DF_MYe = DF_Mw([
  ".description-line{color:rgba(0,0,0,.87);font-size:14px;padding-top:8px;word-break:break-word}#descriptionWrapper{background-color:#fff;border-radius:8px;display:flex;flex-direction:column;font-family:Roboto,sans-serif;padding:16px}.title{color:#000;font-size:14px;font-weight:700;margin:0}",
]);
...
var DF_M8e = DF_Mw([
  ".image{background-repeat:no-repeat;background-size:contain;margin-right:24px;max-height:24px;max-width:24px;padding-right:24px}.title{color:#000;font-family:Roboto,sans-serif;font-size:14px;font-weight:700;margin:0}.subtitle{color:#757575;padding-top:8px}.title-card-elements{background-color:#fff;background:linear-gradient(270deg,#d8d1d5 0,#b1a6b1 47%,#d8d1d5) 0 100% #fff no-repeat;background-size:100% 1px;border-radius:8px;cursor:pointer;display:flex;font-family:Roboto,sans-serif;font-size:14px;padding:16px}.list-button{background-color:transparent;border:none;padding:0;width:100%}button{text-align:left}",
]);
var DF_M9e = DF_Mw([
  ".image{background-repeat:no-repeat;background-size:contain;margin-right:24px;max-height:24px;max-width:24px;padding-right:24px}.link-wrapper{text-decoration:none}.title{color:#000;font-weight:700}.subtitle{color:#757575;padding-top:8px}.title-card-elements{background-color:#fff;border-radius:8px;display:flex;padding:16px}.title,.title-card-elements{font-family:Roboto,sans-serif;font-size:14px}.title{margin:0}",
]);
